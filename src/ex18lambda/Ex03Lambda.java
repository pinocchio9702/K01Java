...
람다식(Lambda Expression)
		...
		불편함 때문에 최근 함수형 프로그래맹(Functional Programming)의 장점이 대두되었고
...
public class Ex03Lambda {
	public static void main(String[] args) {
		...
		/*
		 2번 예제에서의 익명클래슬르 람다식으로 표현하면 아래와 같다. 
		 - 클래스명을 통해 익명클래스를 만드는 부분이 생략된다.
		 - 함수명도 생략한다. 부모에서 오버라딩하므로 유추할 수 있다.
