...
//		MessageSendingThread tr3 = new MessageSendingThread("세번째");
		...
		/*
		 2단계 실행
		 		...
		 		1~10 사이에서 부여할 수 있고 높을 수록 우선순위도
		 		높아지게 된다.
		 		※단 우선순위가 높다고 무조건 먼저 실행되지는 않는다.
		 		전체적인 확률이 높아지게 되어 먼저 실행된 가능성이 높아진다고 생각하면 된다.
		 */
