...
public class Animal {
	...
	public void showAnimal() {
		System.out.println("이 동물의 종은 " + species + "입니다.");
		System.out.println("이 동물의 나이은 " + age + "살 입니다.");
		System.out.println("이 동물의 성별은 " + gender + "입니다.");
	}
	
	/*
	부모클래스의 맴버가 private인 경우 자식클래스에서 접근이
	불가능하므로 반드시 getter/setter 메소드를 통해 접근해야 한다.
	 */
