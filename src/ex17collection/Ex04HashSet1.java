...
public class Ex04HashSet1 {
	...
	public static void main(String[] args) {
		...
		int number = 100; //<- Integer객체로 Boxing처리 후 저장됨
		...
		/*
		 5-2] 개발자가 정의한 객체 중복 저장
		 		...
		 		중복저장이 혀용된다. 아래의 경우 저장에 성공하여 true가 반환된다.
		 */
		...
		//1-7]존재여부 확인
		System.out.println(set.contains(strObject1) ? "strObject1 있다." : "strObject1없다.");
		System.out.println(set.contains("JaVa") ? "JaVa있다." : "JaVa없다.");
		
		//1-8]삭제
		// : Set은 index가 없으므로 참조값으로만 삭제 가능
