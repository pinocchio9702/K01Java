	...
	public static void main(String[] args) {
		/*
		 List<E> 인터페이스 계열의 컬렉션
		 		...
		 		컬렉션이 된다. 즉 ArrayList<Object>로 선언한것과 동일하다.
		 */
		...
		1-1] 객체저장
				...
				add(인덱스, 객체) : 인덱스를 직접 부여하여 객체를 저장한다. 단, 인덱스를
										건너뛰면 예외가 발생한다.
		...
		list.add("트와이스");
		list.add(3, "워너원");
		//list.add(5, "소방차 ㅋㅋ"); //에러발생(인덱스를 건너뛸수 없다.)
		...
		/*
		 ...
		 방법1 : 인덱스로 삭제하기
		 		remove(index) :인덱스를 통해서 삭제를 진행한 후
		 				...
		 				삭제후에는 인덱스가 자동 재부여된다.
		 				삭제 성공시 해당객체를 반환하므로 언떤객체가 삭제되었는지 확인 가능하다.
		 */
