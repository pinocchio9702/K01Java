...
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		/*
		 JDK1.4 이전 버전의 코딩 상태
		 클래스를 통해 객체화 하고, intValue()를 통해 기본자료형으로 변환한다.
		 */
		...
		System.out.println("10을 8진수로 : " + Integer.toBinaryString(10));
		...
		/*
		 ...
		 toString() : 인스턴스 변수를 출력시 참조값이 아니라 실제
		 		저장된 값을 문자열 형태로 반환해 준다.
